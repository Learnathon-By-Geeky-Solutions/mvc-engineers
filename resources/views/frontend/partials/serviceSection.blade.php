      ...
      <div class="home-features-list row gy-xl-0 gy-md-4 gy-3 row-cols-xl-4 row-cols-lg-3 row-cols-sm-2">
          <div>
              <div class="home-features-box">
                  <img class="img-fluid icon" src="{{asset('assets/frontend/images/svg/routing.svg')}}" alt="routing">
          ...
          <div>
              <div class="home-features-box">
                  <img class="img-fluid icon" src="{{asset('assets/frontend/images/svg/3d-rotate.svg')}}" alt="3d-rotate">
                  <div class="home-features-content">
                      <h5>Easiest Order</h5>
          ...
          <div>
              <div class="home-features-box">
                  <img class="img-fluid icon" src="{{asset('assets/frontend/images/svg/truck.svg')}}" alt="truck">
                  <div class="home-features-content">
                      <h5>Most Delivery</h5>
          ...
          <div>
              <div class="home-features-box">
                  <img class="img-fluid icon" src="{{asset('assets/frontend/images/svg/credit-card.svg')}}" alt="truck">
                  <div class="home-features-content">
